...
# A simple python script that calculates file hashes
import FileHash
# --------------------------------------------------
    ...
    for engines in url_report['scans']:
        ...
        if url_report['scans'][engines]['result'] != "clean site":
            ...
            if url_report['scans'][engines]['result'] == "unrated site":
                bad_urls-=1
                unrated_urls+=1
    print("\n{}/{} of the engines flagged this url as malicious and {} engines didn't respond".format(bad_urls, url_engines,unrated_urls))
...
if __name__=='__main__':
    ...
    try:
        ...
        print("File you're trying to upload does not exist, please make sure path to your file is correct!")
        ...
        print("Exceeded the request limit, try making another request. If that doesn't work, wait for a minute and then make another request/You don't have internet connection")
